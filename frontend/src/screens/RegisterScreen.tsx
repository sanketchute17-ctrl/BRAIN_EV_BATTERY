...
export const RegisterScreen: React.FC<RegisterScreenProps> = ({
  ...
  return (
    <div className="h-screen h-[100dvh] w-full bg-slate-950 flex items-center justify-center p-0 sm:p-4 selection:bg-emerald-500/20 relative overflow-hidden">
      ...
      <div className="w-full sm:w-[360px] h-full sm:h-[800px] sm:max-h-[800px] sm:rounded-[42px] relative overflow-hidden shadow-[0_25px_60px_-15px_rgba(0,0,0,0.8)] border-0 sm:border-[8px] sm:border-slate-900 bg-slate-900 text-slate-900 flex flex-col justify-between p-4 sm:p-5 z-10 overflow-y-auto shrink-0">
